...
class App extends React.Component {
  ...
  static defaultProps = {
      ...
      location: "42.3478, -71.0466", // Attention: call is apparently successful, while returning an empty array
  ...
  // Constructor fxn to initialize component state with empty array for "events" property
  constructor(props) {
    // Calls constructor of parent class (React.Component) and passes "props"
    super(props);
